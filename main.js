var app = (function () {
  ...
  const Cn = ue([
      ...
      "Hollywood Undead - Life Fast, Die Young",
      ...
      "Hollywood Undead - Does Everyone In The World Have To Die",
      ...
      "Hollywood Undead - F*ck The World",
      "Hollywood Undead - Usual Suspects",
      "Hollywood Undead - City Of The Dead",
      "Hollywood Undead - World War Me",
      "Hollywood Undead - Ruin My Life",
      "Hollywood Undead - Hourglass",
      "Hollywood Undead - Go To War",
      "Hollywood Undead - Alone At The Top",
      "Hollywood Undead - Dangerous",
      "Hollywood Undead - Happy When I Die",
      "Hollywood Undead - Reclaim",
      "Hollywood Undead - Alright",
      "Hollywood Undead - Evil",
      "Hollywood Undead - Salvation",
      "Hollywood Undead - First Class Suicide",
      "Hollywood Undead - Ransom",
    ...
    On = {
      subscribe: ue(
        [
          ...
          {
            url: "https://soundcloud.com/hollywoodundead/live-forever-1",
            answer: "Hollywood Undead - Live Forever",
          },
          {
            url: "https://soundcloud.com/hollywoodundead/save-me-1",
            answer: "Hollywood Undead - Save Me",
          },

          {
            url: "https://soundcloud.com/amoctonerecords/dead-bite",
            answer: "Hollywood Undead - Dead Bite",
          },
      ...
      c() {
        (n = w("div")),
          (n.innerHTML =
            ...
            artist +
            ' songs.</p> \n\n<p class="mb-3">Each Heardle is randomly chosen from ' +
            artist +
            '\'s discography using Soundcloud.</p> \n\n\n\n <p class="mb-3">Unfortunately, Soundcloud no longer allows 30 second samples of songs that are only available for Soundcloud GO+, meaning many of the songs from before V are unavailable right now.</p> \n\n\n\n <p class="mb-3">This Heardle is 100% fan-made and is not associated with SCNFDM\'s HUrdle.</p> \n\n\n\n  <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">Soundcloud</a>,\n    <a href="https://svelte.dev">Svelte</a>,\n    <a href="https://tailwindcss.com">Tailwind</a>,\n    <a href="https://fonts.google.com/noto/specimen/Noto+Serif+Display">Noto Serif Display</a>, <a href="https://fonts.google.com/noto/specimen/Noto+Sans">Noto Sans</a>,\n    <a href="https://iconsvg.xyz">IconSVG</a>, <a href="https://momentjs.com">momentjs</a>,\n    <a href="https://tarekraafat.github.io/autoComplete.js/#/">autocomplete.js</a>, and powered by <a href="https://www.netlify.com/">Netlify</a>. <a href="https://omakase.studio" title="Studio Omakase">Served omakase / お任せ</a>. '),
          M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
    ...
    return {
      c() {
        (n = w("div")),
          (r = w("a")),
          (r.innerHTML =
            '<p class="mb-3"><p class="mb-3">This version of the Hollywood Undead Heardle is maintained by @theysentthree. If you find a bug or want to help with the Heardle, you can contact me via Discord.</p>'),
          M(n, "class", "text");
      },
      m(e, o) {
